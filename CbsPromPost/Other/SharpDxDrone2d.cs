    ...
    protected sealed override void DrawUser()
    {
        ...
        lock (this)
        {
            ...
            Rt?.FillRectangle(
                ...
                Brushes.RoiNone);
            Rt?.FillRectangle(
                new RawRectangleF(Motors[0].Position.X - rtW / 2f - 70f, Motors[0].Position.Y + rtH / 2f + rtH*((_betaflight.Motor1-1000f)/-1000f),
            ...
            Rt?.FillRectangle(
                ...
                Brushes.RoiNone);
            Rt?.FillRectangle(
                new RawRectangleF(Motors[1].Position.X - rtW / 2f - 70f, Motors[1].Position.Y + rtH / 2f + rtH * ((_betaflight.Motor2 - 1000f) / -1000f),
            ...
            Rt?.FillRectangle(
                ...
                Brushes.RoiNone);
            Rt?.FillRectangle(
                new RawRectangleF(Motors[2].Position.X - rtW / 2f + 70f, Motors[2].Position.Y + rtH / 2f + rtH * ((_betaflight.Motor3 - 1000f) / -1000f),
            ...
            Rt?.FillRectangle(
                ...
                Brushes.RoiNone);
            Rt?.FillRectangle(
                new RawRectangleF(Motors[3].Position.X - rtW / 2f + 70f, Motors[3].Position.Y + rtH / 2f + rtH * ((_betaflight.Motor4 - 1000f) / -1000f),
